...
class LichessLinkOAuthSourcePinTest {
    ...
    private val redirectPath =
        "src/main/java/ai/chesscoach/app/LichessLinkRedirectActivity.kt"
    private val flowPath = "src/main/java/ai/chesscoach/app/LichessLinkFlow.kt"
    private val viewModelPath =
        "src/main/java/ai/chesscoach/app/LichessConnectViewModel.kt"
    private val modelsPath = "src/main/java/ai/chesscoach/app/LichessApiModels.kt"
